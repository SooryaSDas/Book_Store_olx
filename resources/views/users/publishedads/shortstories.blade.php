               ...
               <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-item">
                            <li class="nav-item">
                                <a href="#home" class="nav-link" data-togle="tab"> Short Stories</a>
                            </li>
                        </ul>
                        <div id="mytabcontent" class="tabcontent">
                            <div id="home">
                            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{url('/shortstories')}}" style="padding-left:20px">
