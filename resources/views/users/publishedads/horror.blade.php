      ...
      <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder"> 
        ...
        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
          <div class="more-info-tab clearfix ">
            <h3 class="new-product-title pull-left">Horror Books</h3>
          </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="mytabcontent" class="tabcontent">
                            <div id="home">
                            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{url('/horror')}}" style="padding-left:20px">
