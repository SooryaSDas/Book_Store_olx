               ...
               <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="mytabcontent" class="tabcontent">
                            <div id="home">
                        <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{url('/actionadventure')}}" style="padding-left:20px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <span class="alert alert-danger" style="margin-left:13px; padding:5px;">
                                        {{$errors->first('photos')}}
                                    </span>
                                    @endif 
                                </div>
